...
namespace ngl::render::task
{
    ...
    public:
        ...
        void Setup(rtg::RenderTaskGraphBuilder& builder, rhi::DeviceDep* p_device, const RenderPassViewInfo& view_info, const SetupDesc& desc)
        {
            ...
            // Rtgリソースセットアップ.
            {
                rtg::RtgResourceDesc2D depth_desc = rtg::RtgResourceDesc2D::CreateAsAbsoluteSize(desc_.w, desc_.h, gfx::MaterialPassPsoCreator_depth::k_depth_format);
            ...
            builder.RegisterTaskNodeRenderFunction(this,
                [this](rtg::RenderTaskGraphBuilder& builder, rtg::TaskGraphicsCommandListAllocator command_list_allocator)
                {
                    ...
                    ngl::gfx::RenderMeshWithMaterial(*commandlist, gfx::MaterialPassPsoCreator_depth::k_name, desc_.gfx_scene, *desc_.p_mesh_proxy_id_array, render_mesh_res);
                });
        }
    };
