    ...
    uint gindex : SV_GroupIndex)
{
    ...
    const int2 center_texel_pos = probe_tile_id * SCREEN_SPACE_PROBE_OCT_RESOLUTION + local_cell;
    ...
    for (int i = 0; i < 4; ++i)
    {
        ...
        const float4 neighbor_value = ScreenSpaceProbeTex.Load(int3(neighbor_tile * SCREEN_SPACE_PROBE_OCT_RESOLUTION + local_cell, 0));
