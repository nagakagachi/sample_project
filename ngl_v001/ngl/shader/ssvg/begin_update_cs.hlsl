...
)
{
    ...
    uint voxel_count = cb_dispatch_param.BaseResolution.x * cb_dispatch_param.BaseResolution.y * cb_dispatch_param.BaseResolution.z;
        ...
        {
            bool is_invalidate_area = any(voxel_coord < cb_dispatch_param.GridCellDelta) || any(voxel_coord >= (cb_dispatch_param.BaseResolution - int3(1,1,1) - cb_dispatch_param.GridCellDelta));// 範囲外の領域に進行した場合はその領域をInvalidate.
